                ...
                <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                    <div className="flex items-center justify-center">
                        ...
                        <div className="hidden mx-10 md:block">
                                <div className="relative">
                                    ...
                                    <input type="text" className="w-full py-2 pl-10 pr-4 text-gray-700 bg-white  border-b-2 border-black dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:outline-none bold-placeholder " placeholder="Search" />
                            ...
                            <h1 className='text-4xl font-bold lg:ml-52 '>PURE BLISS</h1>
                    ...
                    <div className={`${isOpen ? 'translate-x-0 opacity-100' : 'opacity-0 -translate-x-full'} absolute inset-x-0 z-20 w-full px-6 py-2 transition-all duration-300 ease-in-out bg-white top-24 dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:bg-transparent md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center`}>
                        <div className="flex flex-col md:flex-row md:mx-1">
                            ...
                            <a className="my-2 text-sm leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0" href="#">WishList </a>
                            <FaRegHeart />
                            </div>
                            <div className='flex flex-row items-center' >
                            <a className="my-2 text-sm leading-5 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0" href="#">Bag </a>
                            <IoBagOutline />
                            </div>
