...
const MakeUpStories = () => {
    return (
        <div className="bg-black mt-20 p-20">
            <div>
          ...
          <div className="flex lg:flex-row flex-col justify-center items-center gap-2">
            {/* div 1 */}
            <div className="card bg-black w-96 shadow-xl mt-16 lg:transition-transform lg:duration-500 lg:ease-in-out lg:transform lg:hover:scale-110">
